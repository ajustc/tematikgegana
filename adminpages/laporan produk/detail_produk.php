                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Email</th>
                                        <td style="text-transform:uppercase"><?php echo $pembayaran['bank']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Isi Laporan</th>
                            ...
                            <div class="col-md-4">
                                <img src="../../file/laporan_pesanan/<?php echo $pembayaran['bukti'] ?>" style="width:300px; height:auto;" class="img-responsive">
                            </div>
