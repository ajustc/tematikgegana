		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div id="slider-carousel" class="carousel slide" data-ride="carousel">
					...
					<a href="#slider-carousel" class="left-head control-carousel hidden-xs" data-slide="prev">
						<i class="fa fa-angle-left"></i>
					</a>
					<a href="#slider-carousel" class="right-head control-carousel hidden-xs" data-slide="next">
		...
		<div class="row">
			...
			<div class="col-sm-9 padding-right">
				<div class="features_items">
					...
					$pro = mysqli_query($koneksi, "select * from tbl_produk ORDER BY id_produk DESC LIMIT $posisi,$batas");
		...
		<div id="testimoni" class="row">
			...
			<div id="testimoni-carousel" class="carousel slide" data-ride="carousel">
				<div class="carousel-inner text-center" role="listbox">
					...
					while ($row = mysqli_fetch_array($testimoni)) {
					?>
						<div class="item caro <?php if ($no == 0) {
													echo 'active';
												} else {
													echo '';
												} ?>">
